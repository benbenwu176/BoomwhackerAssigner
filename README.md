...
3. In the notes folder, you will now find a (or several) tsv files. Take note of the name of the file that corresponds to the sheet music that you want to parse.
  
4. MsczReader.java is the main file. Run it and input the name of the tsv file that you just extracted. (ex. test.notes.tsv)
